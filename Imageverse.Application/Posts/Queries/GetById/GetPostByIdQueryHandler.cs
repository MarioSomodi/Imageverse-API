...
{
	public class GetPostByIdQueryHandler : IRequestHandler<GetPostByIdQuery, ErrorOr<PostResult>>
	{
		private readonly IUnitOfWork _unitOfWork;
		private readonly IAWSHelper _aWSHelper;

		public GetPostByIdQueryHandler(IUnitOfWork unitOfWork, IAWSHelper aWSHelper)
		{
			_unitOfWork = unitOfWork;
			_aWSHelper = aWSHelper;
		}

		public async Task<ErrorOr<PostResult>> Handle(GetPostByIdQuery request, CancellationToken cancellationToken)
		{
